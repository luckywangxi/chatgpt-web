...
async function fetchUsage(key: string | undefined = undefined) {
  const OPENAI_API_KEY = (key === '1' || key === undefined) ? process.env.OPENAI_API_KEY : key
...
export { chatReplyProcess, chatConfig, currentModel, setApiKey }
